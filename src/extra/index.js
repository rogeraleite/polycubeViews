...
var OrbitControls = (function (_super) {
    ...
    OrbitControls.prototype.pan = function (deltaX, deltaY) {
        ...
        if (this.object instanceof THREE.PerspectiveCamera || this.object.type == "PerspectiveCamera") {
            // perspective
            var position = this.object.position;
        ...
        else if (this.object instanceof THREE.OrthographicCamera || this.object.type == "OrthographicCamera") {
            // orthographic
